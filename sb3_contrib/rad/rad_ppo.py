...
from sb3_contrib.rad.augmented_buffers import AugmentedRolloutBuffer, AugmentedDictRolloutBuffer
...
class RAD_PPO(PPO):
    ...
    def _setup_model(self) -> None:
        super(RAD_PPO, self)._setup_model()
